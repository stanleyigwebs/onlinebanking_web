...
if (isset($_GET['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM passbook" . $cust_id . " WHERE trans_id = $delete_id";
    ...
    $sql1 = "SELECT * FROM customer".$_SESSION['cust_id'];
        ...
        <?php
            ...
            while($row = $result->fetch_assoc()) {?>
                    <tr>
                       ...
                       <td> <a class="btn btn-danger btn-sm" href="transactions.php?cust_id=<?php echo $cust_id; ?>&page=<?php echo $page; ?>&delete_id=<?php echo $row['trans_id']; ?>" class="delete-btn">Delete</a></td>
