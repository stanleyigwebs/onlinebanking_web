<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($by == "name") {
            $sql0 = "SELECT cust_id, first_name, last_name, account_no , uname FROM customer
            WHERE uname LIKE '%".$search."%' OR account_no LIKE '%".$search."%'
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="flex-item">
                    ...
                    <div class="flex-item-2">
                        <p id="name"><?php echo $row["uname"] . " " . $row["account_no"]; ?></p>
                        <p id="acno"><?php echo "Passbook/No : " . "Passbook".$row["cust_id"]; ?></p>
                    </div>
                    <div class="flex-item-1">
                        <div class="dropdown">
                          ...
                          <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                            ...
                            <a href="history.php?cust_id=<?php echo $row["cust_id"] ?>">Add Transaction</a>
                            <a href="bulk_build.php?cust_id=<?php echo $row["cust_id"] ?>">Import History</a>
                          </div>
                        </div>
                    </div>
                </div>
